# Full PyTorch training script for minispectro_cnn
import os
import time
import torch
...
def run_experiment(image_type, folds=5, batch_size=32, epochs=30):
    print(f"\n========= Training custom cnn on {image_type.upper()} =========")
...
print(results_df)
results_df.to_csv("customcnn2_results.csv", index=False)
print("Results saved to 'customcnn2_results.csv'.")
